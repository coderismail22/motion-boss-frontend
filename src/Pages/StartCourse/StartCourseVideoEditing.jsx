...
const StartCourseVideoEditing = () => {
    ...
    const videoEditing = [
        { title: 'ক্লাস ১1', vid: 'VJsf81SuJEQ?si=Zh6-azDXsVYCKGP0', classNme: 'Adobe After Effects Basic Interface | Motion Graphics and VFX in After Effects' },
        { title: 'ক্লাস ২2', vid: '1bKMxTx1zuE?si=JjnCJAytFf1x1HDk', classNme: 'Understanding Animation Process by a Simple Project | Motion Graphics and VFX in After Effects' },
        { title: 'ক্লাস ৩3', vid: 'tLw69muJfBg?si=FcnNankm1_vBVkqY', classNme: 'Understanding Animation Process in After Effects by a Simple Project 02' },
