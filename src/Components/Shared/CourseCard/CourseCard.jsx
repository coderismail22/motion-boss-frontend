...
const CourseCard = ({ course }) => {
    const { courseId, courseName, categoryName, start_course_name, totalClasses, trainerImageUrl, trainerName, price, thumbnail_url } = course;
            ...
            <div className="card card-compact bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className="flex items-center gap-2 bg-slate-100 p-1 mt-2 rounded-md">
                        ...
                        <Link>
                            <p className="text-[#3a67ae] font-semibold text-[16px]">{trainerName}</p>
                        </Link>
                    </div>
                        ...
                        <div className="w-7/12">
                            <Link to={`course/${start_course_name}`}>
                                <button className="btn text-white bg-gradient-to-r w-full font-semibold text-[16px] from-cyan-500 to-blue-500">
                                    <samp className="text-xl"><BiCategoryAlt /></samp> View Course Details
                                </button>
                            </Link>
                        </div>
                        <div>
                            <button onClick={handleAddToCart} className="btn btn-outline mx-5 btn-primary text-yellow-600">
                                <span><FiShoppingCart /></span> Add Cart
                            </button>
                        </div>
                    </div>
                </div>
