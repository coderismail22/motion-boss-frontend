        ...
        <div>
            <footer className="footer p-10 bg-[#2B3440] text-[#CDD3DA]  ">
                ...
                <nav>
                    ...
                    <div className="mt-5">
                        <p>Developer</p>
                        <h3 className="text-xl">Sheikh Sakibul Hasan</h3>
                        <a className="text-blue-600" href="https://www.facebook.com/profile.php?id=100085858864653">Connect to Facebook</a>
                    </div>
                </nav>
            </footer>
        </div>
